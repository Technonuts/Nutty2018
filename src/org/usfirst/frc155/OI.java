...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("Move Lift: Floor", new MoveLift(Elevator.STOW));
        SmartDashboard.putData("Move Lift: Switch", new MoveLift(Elevator.SWITCH));
        SmartDashboard.putData("Move Lift: LowScale", new MoveLift(Elevator.SCALE));
        SmartDashboard.putData("Move Lift: HighScale", new MoveLift(Elevator.HANG));
