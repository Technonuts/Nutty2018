 ...
 *
 */
public class SecondDriveStraightDistance extends Command {
	...
	private static final double kPAng = 1;
	...
	public SecondDriveStraightDistance(double distance, double maxSpeed) {
	...
	protected void execute() {
		...
		m_error = m_distance - ((Robot.drivetrain.getLeftEncoder().getDistance()+ Robot.drivetrain.getLeftEncoder().getDistance())/2);
		/*
		...
		System.out.println( Robot.drivetrain.getGyro());
		System.out.println("drift " +m_drift);
		 ...
		 * kPAng * m_drift;
		 */
		System.out.println("turnrate " +m_turnrate);
	...
	protected boolean isFinished() {
		...
		if( (Math.abs(m_error) <= kTolerance) || (Timer.getMatchTime()>=4)){
			return true;
		}
		else {
			return false;
