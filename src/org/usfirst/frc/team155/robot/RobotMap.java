...
public final static int ARDUINO_0 = 10;
public final static int ARDUINO_1 = 11;
public final static int ARDUINO_2 = 12;
public final static int ARDUINO_3 = 13;

public static DigitalOutput LEDard_0;
public static DigitalOutput LEDard_1;
public static DigitalOutput LEDard_2;
public static DigitalOutput LEDard_3;
...
//>>>>>>> branch 'master' of https://github.com/Technonuts/Nutty2018.git
    ...
    public static void init  () {
    	 LEDard_0 = new DigitalOutput(ARDUINO_0); 
		 LEDard_1 = new DigitalOutput(ARDUINO_1); 
		 LEDard_2 = new DigitalOutput(ARDUINO_2);
		 LEDard_3 = new DigitalOutput(ARDUINO_3);
